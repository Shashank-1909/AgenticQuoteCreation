...
# ---------------------------------------------------------------------------
# Twin Hunter tools — business logic lives in app/services/twin_hunter_service.py
# No Twin Hunter code should remain in this file beyond this import.
# ---------------------------------------------------------------------------
from app.services.twin_hunter_service import (
    get_twin_account_context,
    research_twin_candidates,
    build_twin_cards,
)
...
if agent_type in ["twin", "all"]:
    mcp.add_tool(get_twin_account_context)
    mcp.add_tool(research_twin_candidates)
    mcp.add_tool(build_twin_cards)
    mcp.add_tool(get_my_accounts)
