...
const STYLES = `
  ...
  @keyframes tool-glow-pulse {
    0%, 100% { box-shadow: 0 0 10px var(--tc, #22d3ee55), 0 0 20px var(--tc, #22d3ee22); }
    50%       { box-shadow: 0 0 18px var(--tc, #22d3ee88), 0 0 36px var(--tc, #22d3ee33); }
  }
                  ...
                  {results.map(prod => {
                    ...
                    return (
                      <div key={prod.id}
                        ...
                        className="px-3 py-3 border rounded-xl cursor-pointer transition-all select-none"
                        style={{
                          background: isSel ? 'rgba(99,102,241,0.08)' : 'rgba(10,12,20,1)',
                          borderColor: isSel ? 'rgba(99,102,241,0.4)' : 'rgba(255,255,255,0.05)',
                        }}>
                        <div className="flex items-center gap-2.5">
                          {/* Checkbox */}
                          <div style={{
                            width: 14, height: 14, borderRadius: 4, flexShrink: 0,
                            border: `1.5px solid ${isSel ? '#6366f1' : 'rgba(255,255,255,0.12)'}`,
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-[8.5px] font-black text-slate-600 uppercase tracking-widest mt-0.5">{prod.sku}</div>
                          </div>
                        </div>
                      </div>
                    );
